namespace lab3_1
{
    ...
    public class Sequencee
    {
        ...
        public bool Equal(Sequencee numbers2)
        {
        ...
        public static Sequencee LoadFromJsonFile(string filePath)
        {
            string jsonData = File.ReadAllText(filePath);
            Sequencee loadedSequence = JsonConvert.DeserializeObject<Sequencee>(jsonData);
